...
namespace Netezos.Tests.Keys
{
    public class HDKeyTests
    {
        ...
        #region Ed25519
        [Fact]
        public void TestVector1Ed25519Test0()
        {
            const string keyHexExpected = "2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7";
            const string chainCodeExpected = "90046a93de5380a72b5e45010748567d5ea02bbf6522f979e05c0d8d8ca9fffb";
            
            var key = HDKey.FromHex(Vector1Seed);

            Assert.Equal(keyHexExpected, key.Key.GetHex());
            Assert.Equal(chainCodeExpected, key.ChainCode.ToStringHex());
        }
        ...
        public void TestVector1Ed25519Test1()
        {
            ...
            var key = HDKey.FromHex(Vector1Seed).Derive(HDPath.Parse(expectedPath));
        ...
        [Fact]
        public void TestVector1Ed25519Test12()
        {
            const string expectedPath = "m";
            const string expectedChainCode = "90046a93de5380a72b5e45010748567d5ea02bbf6522f979e05c0d8d8ca9fffb";
            const string expectedKey = "2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7";
            // const string expectedPublicKey = "8c8a13df77a28f3445213a0f432fde644acaa215fc72dcdf300d5efaa85d350c";
        ...
        public void TestVector2Ed25519Test1()
        {
            ...
            var key = HDKey.FromHex(Vector2Seed).Derive(HDPath.Parse(expectedPath));
