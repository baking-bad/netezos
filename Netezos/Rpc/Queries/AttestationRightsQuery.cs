namespace Netezos.Rpc.Queries
{
    ...
    {
        internal AttestationRightsQuery(RpcQuery baseQuery, string append) : base(baseQuery, append) { }
        ...
        /// Executes the query and returns the attestation rights
        /// </summary>
        /// <param name="cycle">Cycle at which the attestation rights are to be returned</param>
        /// <returns></returns>
