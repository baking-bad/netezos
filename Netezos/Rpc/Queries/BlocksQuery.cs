namespace Netezos.Rpc.Queries
{
    ...
    public class BlocksQuery : RpcObject
    {
        ...
        /// </summary>
        public BlockQuery Head => new(this, "head/");
        ...
        /// <returns></returns>
        public BlockQuery this[int level] => level >= 0 ? new(this, $"{level}/") : new(this, $"head~{-level}/");
        ...
        /// <returns></returns>
        public BlockQuery this[string hash] => new(this, $"{hash}/");
        ...
        /// Executes the query and returns known heads of the blockchain, sorted with decreasing fitness
        /// </summary>
        /// <param name="length">Number of blocks per head (head + predecessors) to returns</param>
        /// <returns></returns>
        ...
        /// <param name="length">Number of blocks (head + predecessors) to returns</param>
        /// <returns></returns>
